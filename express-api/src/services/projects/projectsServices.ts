...
import { constructFindOptionFromQuery, constructFindOptionFromQuerySingleSelect } from '@/utilities/helperFunctions';
...
const collectFindOptions = (filter: ProjectFilter) => {
  ...
  if (filter.agency) options.push(constructFindOptionFromQuerySingleSelect('Agency', filter.agency));
