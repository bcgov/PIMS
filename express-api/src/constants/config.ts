const config = {
  ches: {
    ...
    emailAuthorized: process.env.CHES_EMAIL_AUTHORIZED === 'true', //For use in live testing environments. If true, and there is no override_to set, the requesting SSO user's email will be used as the to field.
  },
  ltsa: {
