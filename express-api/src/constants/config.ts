const config = {
  ches: {
    ...
    emailAuthorized: process.env.CHES_EMAIL_AUTHORIZED === 'true', //For use in live testing environments. If this is false, and there is no overrideTo set, the requesting SSO user's email will be used as the "To" field.
  },
  ltsa: {
