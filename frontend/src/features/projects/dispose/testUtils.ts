...
export const mockApiProject = {
  ...
  tasks: [
    ...
    },
    {
      ...
      description: 'ADM has confirmed request for exemption',
      isOptional: false,
      isDisabled: false,
      sortOrder: 2,
      statusId: 13,
  ...
  properties: [
    {
      ...
      assessedFirm: '',
      assessedRowVersion: 'AAAAAAAAWyU=',
      appraised: 0,
      appraisedDate: undefined,
      appraisedFirm: undefined,
      appraisedRowVersion: undefined,
      netBook: 1,
      netBookFiscalYear: 2021,
      netBookRowVersion: 'AAAAAAAAWyY=',
      estimated: 1,
      estimatedFiscalYear: 2021,
      estimatedRowVersion: 'AAAAAAAAWyc=',
      propertyTypeId: 0,
      propertyType: 'Land',
      landArea: 34.74,
    },
