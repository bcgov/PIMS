          ...
          if (data.latitude && data.longitude) {
            parcelsService
              ...
              .then(response => {
                ...
                //it is possible the the geocoder will fail to get the pid the parcel layer service will succeed. In that case, double check that the pid doesn't exist within pims.
                if (pid) {
                  const parcelLayerSearchCallback = () => {
