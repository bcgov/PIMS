...
namespace Pims.Tools.Core
{
    ...
    public class RequestClient : IRequestClient
    {
        ...
        public RequestClient(IOptionsMonitor<RequestOptions> options, IOpenIdConnector auth, IHttpClientFactory clientFactory, JwtSecurityTokenHandler tokenHandler, ILogger<RequestClient> logger)
        {
            _options = options.CurrentValue;
            _auth = auth;
            _client = clientFactory.CreateClient("Pims.Tools.Core.RequestClient");
            ...
            where RT : class
        {
            ...
            catch (HttpRequestException)
            {
                ...
                if (_options.RetryAfterFailure && attempt <= _options.RetryAttempts)
                {
            ...
            where T : class
        {
            ...
            {
                _logger.LogError($"Request failed: status: {ex.StatusCode} Details: {ex.Details}");
