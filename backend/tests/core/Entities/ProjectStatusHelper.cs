    ...
    public static partial class EntityHelper
    {
        ...
        public static List<Entity.ProjectStatus> CreateDefaultProjectStatus()
        {
            return new List<Entity.ProjectStatus>()
            {
                ...
                new Entity.ProjectStatus("Submitted", "AS-I") { Id = 7, SortOrder = 6, IsMilestone = true, Route = "{DR}", RowVersion = new byte[] { 12, 13, 14 } },
                new Entity.ProjectStatus("Submitted Exemption", "AS-EXE") { Id = 8, SortOrder = 6, IsMilestone = true, Route = "{DR}", RowVersion = new byte[] { 12, 13, 14 } },
                ...
                new Entity.ProjectStatus("Exemption Review", "AS-EXP") { Id = 13, SortOrder = 10, Route = "{EX}", RowVersion = new byte[] { 12, 13, 14 } },
                ...
                new Entity.ProjectStatus("Approved for Exemption", "AP-EXE") { Id = 15, SortOrder = 11, IsMilestone = true, Route = "{EX}", RowVersion = new byte[] { 12, 13, 14 } },
                new Entity.ProjectStatus("Denied", "DE") { Id = 16, SortOrder = 11, IsMilestone = true, Route = "{AS}, {EX}", RowVersion = new byte[] { 12, 13, 14 } },
                ...
                new Entity.ProjectStatus("On Hold", "ERP-OH") { Id = 30, SortOrder = 17, Route = "{ERP}", RowVersion = new byte[] { 12, 13, 14 } },

                new Entity.ProjectStatus("Disposed", "DIS") { Id = 31, SortOrder = 21, IsMilestone = true, Route = "{EX}, {ERP}", RowVersion = new byte[] { 12, 13, 14 } },
                ...
                new Entity.ProjectStatus("Disposed", "SPL-DIS") { Id = 43, SortOrder = 21, IsMilestone = true, Route = "{SPL}", RowVersion = new byte[] { 12, 13, 14 } },
            };
        }
