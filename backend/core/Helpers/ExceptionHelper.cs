...
namespace Pims.Core.Helpers
{
    ...
    public static class ExceptionHelper
    {
        ...
        /// <summary>
        /// Provides a simple try+catch wrapper to set a variable.
        /// This duplicate is required to handle the overloading when `defaultValue` == null.
        /// </summary>
        /// <param name="getter"></param>
        /// <param name="defaultValue"></param>
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public static T HandleKeyNotFoundWithDefault<T>(Func<T> getter, T defaultValue)
        {
            return HandleKeyNotFound(getter, (T)defaultValue);
        }
