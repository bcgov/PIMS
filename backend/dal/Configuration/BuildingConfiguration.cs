...
namespace Pims.Dal.Configuration
{
    ...
    public class BuildingConfiguration : PropertyConfiguration<Building>
    {
        ...
        public override void Configure(EntityTypeBuilder<Building> builder)
        {
            ...
            builder.HasIndex(m => new { m.Id, m.Latitude, m.Longitude, m.IsSensitive, m.AgencyId, m.ParcelId, m.ClassificationId, m.AddressId, m.ProjectNumber, m.BuildingConstructionTypeId, m.BuildingPredominateUseId, m.BuildingOccupantTypeId, m.BuildingFloorCount, m.BuildingTenancy });
            builder.HasIndex(m => new { m.Id, m.IsSensitive, m.AgencyId, m.ParcelId, m.ClassificationId, m.AddressId, m.ProjectNumber, m.BuildingPredominateUseId, m.BuildingConstructionTypeId, m.BuildingOccupantTypeId, m.BuildingFloorCount, m.BuildingTenancy });
