...
namespace Pims.Dal.Configuration
{
    ...
    public class BuildingConfiguration : PropertyConfiguration<Building>
    {
        ...
        public override void Configure(EntityTypeBuilder<Building> builder)
        {
            ...
            builder.HasIndex(m => new { m.Id, m.IsSensitive, m.AgencyId, m.ClassificationId, m.AddressId, m.ProjectNumber, m.BuildingConstructionTypeId, m.BuildingPredominateUseId, m.BuildingOccupantTypeId, m.BuildingFloorCount, m.BuildingTenancy });
