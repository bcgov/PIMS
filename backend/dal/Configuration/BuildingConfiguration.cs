...
namespace Pims.Dal.Configuration
{
    ...
    public class BuildingConfiguration : PropertyConfiguration<Building>
    {
        ...
        public override void Configure(EntityTypeBuilder<Building> builder)
        {
            ...
            builder.HasIndex(m => new { m.Latitude, m.Longitude, m.LocalId, m.IsSensitive, m.AgencyId, m.StatusId, m.ClassificationId, m.BuildingConstructionTypeId, m.BuildingPredominateUseId, m.BuildingOccupantTypeId, m.BuildingFloorCount, m.BuildingTenancy });
