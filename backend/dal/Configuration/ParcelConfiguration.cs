...
namespace Pims.Dal.Configuration
{
    ...
    public class ParcelConfiguration : PropertyConfiguration<Parcel>
    {
        ...
        public override void Configure(EntityTypeBuilder<Parcel> builder)
        {
            ...
            builder.Property(m => m.Zoning).HasMaxLength(250);
            builder.Property(m => m.ZoningPotential).HasMaxLength(250);
            ...
            builder.HasIndex(m => new { m.Latitude, m.Longitude, m.StatusId, m.IsSensitive, m.AgencyId, m.ClassificationId, m.LandArea, m.Municipality, m.Zoning, m.ZoningPotential, m.Description });
