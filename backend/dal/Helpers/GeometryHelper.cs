...
{
    /// <summary>
    /// GeometeryHelper static class, provides methods to help with goemetric shapes.
    /// </summary>
    public static class GeometeryHelper
    {
        /// <summary>
        ...
        /// <param name="srid">Spatial Reference Identifier (SRID) is a unique identifier associated with a specific coordinate system, tolerance, and resolution (default 4326).</param>
        /// <returns></returns>
