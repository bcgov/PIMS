    ...
    public class ImportPropertiesHelper
    {
        ...
        private Entity.Parcel AddUpdateParcel(Model.ImportPropertyModel property, int pid, Entity.Agency agency)
        {
            ...
            if (p_e.Id == 0 || fiscalNetBook == null || evaluationAssessed == null)
            {
                ...
                var lng = property.Longitude != 0 ? property.Longitude : p_e.Location.X; // This is to stop data from some imports resulting in removing the lat/long.
                var lat = property.Latitude != 0 ? property.Latitude : p_e.Location.Y;
        ...
        private Entity.Parcel AddUpdateBuilding(Model.ImportPropertyModel property, int pid, Entity.Agency agency)
        {
            ...
            if (b_e.Id == 0 || fiscalNetBook == null || evaluationAssessed == null)
            {
                ...
                var lng = property.Longitude != 0 ? property.Longitude : b_e.Location.X; // This is to stop data from some imports resulting in removing the lat/long.
                var lat = property.Latitude != 0 ? property.Latitude : b_e.Location.Y;
