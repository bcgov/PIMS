...
namespace Pims.Api.Models
{
    ...
    public class ParcelDetail
    {
        ...
        public ParcelDetail(Pims.Dal.Data.Entities.Parcel parcelDetail)
        {
            this.Address = parcelDetail.Address != null ? new Address(parcelDetail.Address) : null;
            ...
            this.Buildings = parcelDetail.Buildings
              ...
              .Select(buildingEntity => new Building(buildingEntity))
              .ToArray();
